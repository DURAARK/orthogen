...
SET DS2IM=%DS1PATH%\
SET DS2MG=%DS1PATH%\OBJ\ModelledSpace.obj
SET DS2RG=%DS1PATH%\OBJ\RansacRegisteredPlanes.obj
...
cd ds2_ransac
..\..\..\MSVC2013\Release\orthogen.exe --im=%DS1IM% --ig=%DS1RG% --rot 0.0266818 0.00336098 0.00221603 0.999636 --trans 0 0 0 --res 1 --elevation -1.570796327 1.570796327 --scale mm --exgeom  1
cd..
