...
cd ds2_ransac
..\..\..\MSVC2013\Release\orthogen.exe --im=%DS2IM% --ig=%DS2RG% --rot 0.5777548965 0.0002047265214 -0.004375523157 -0.8161985619 --trans 0 0 -65.6473 --res 1 --elevation -1.570796327 1.570796327 --scale m --exgeom  1
cd..

if not exist ds2_ransac_faro mkdir ds2_ransac_faro
cd ds2_ransac_faro
..\..\..\MSVC2013\Release\orthogen.exe --im=%DS2IM2% --ig=%DS2RG% --rot 0.5777548965 0.0002047265214 -0.004375523157 -0.8161985619 --trans 0 0 -65.6473 --res 1 --elevation -1.046266501 1.569409603 --scale m --exgeom  1
cd..

rem if not exist ds3_ransac mkdir ds3_ransac
rem cd ds3_ransac
rem ..\..\..\MSVC2013\Release\orthogen.exe --im=%DS3IM% --ig=%DS3RG% --rot 0.3473116843 -0.005407991293 -0.003936551737 0.9377258934 --trans 0 0 0.8 --res 1 --elevation -1.046266501 1.570022792 --scale m --exgeom  1
rem cd..
